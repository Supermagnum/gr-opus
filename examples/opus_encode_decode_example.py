...
from gnuradio import audio, gr, gr_opus
...
def main():
    ...
    # Opus encoder
    encoder = gr_opus.opus_encoder(sample_rate=sample_rate, channels=1, bitrate=64000, application="audio")

    # Opus decoder
    decoder = gr_opus.opus_decoder(sample_rate=sample_rate, channels=1, packet_size=0)  # Auto-detect packet size
