...
class qa_opus_decoder(unittest.TestCase):
    ...
    def test_002_decoder_initialization_custom_params(self):
        ...
        decoder = opus_decoder(sample_rate=16000, channels=2, packet_size=100)
    ...
    def test_009_decoder_stereo(self):
        ...
        encoded_packet = self._generate_encoded_packet(sample_rate=self.sample_rate, channels=2)

        decoder = opus_decoder(sample_rate=self.sample_rate, channels=2, packet_size=len(encoded_packet))
